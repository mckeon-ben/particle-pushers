...
DATA_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                        'data')
DATA_FILE = os.path.join(DATA_DIR, 'coulomb_scattering.json')

# Names the figure.
EXPERIMENT = 'Coulomb scattering'
...
def coulomb_field(alpha=ALPHA):
    '''
    Coulomb field of a fixed point charge, with no magnetic field.

    Parameters
    ----------
    alpha : float, optional
        Source strength; positive for a repulsive field.

    Returns
    -------
    StaticField
        The electric field, with zero magnetic field.
    '''
