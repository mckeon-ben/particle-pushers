...
All lab frame pushers are second-order accurate in the lab time step $\Delta t$. Similarly, all comoving frame pushers are second-order accurate in the proper time step $\Delta \tau$.
