...
All lab frame pushers are second-order accurate in the lab frame time step $\Delta t$. Likewise, all comoving frame pushers are second-order accurate in the proper time step $\Delta \tau$.
